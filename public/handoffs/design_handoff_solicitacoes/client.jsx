...
function CatalogRow({ form, onOpen }) {
  ...
  return (
    <div className="cat-row" onClick={() => onOpen(form)}>
      ...
      <div className="cat-actions">
        <button className="btn btn-ghost btn-sm" onClick={(e) => { e.stopPropagation(); onOpen(form); }}>
          <I.eye size={14} /> Ver
        </button>
        <button className="btn btn-accent btn-sm" onClick={(e) => { e.stopPropagation(); onOpen(form); }}>
      ...
      <div className="cv-grid">
        ...
        <div>
          ...
          <div className="cat-list">
            {forms.map(f => <CatalogRow key={f.id} form={f} onOpen={setDrawer} />)}
            {forms.length === 0 && (
        ...
        <aside>
          <div className="card" style={{ padding: 18, position: "sticky", top: 0 }}>
            ...
            <button className="btn btn-ghost" style={{ width: "100%" }}><I.board size={15} /> Abrir o Kanban</button>
          </div>
        </aside>
      </div>

      <Drawer form={drawer} onClose={() => setDrawer(null)} />
    </div>
  );
}
