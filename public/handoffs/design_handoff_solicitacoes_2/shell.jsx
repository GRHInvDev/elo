...
function App() {
  ...
  const renderClient = () => {
    if (route.name === "form") return <FormRootPage form={findForm(route.id)} nav={nav} />;
    if (route.name === "respond") return <RespondPage form={findForm(route.id)} nav={nav} />;
    if (route.name === "mine") return <MyResponsesPage nav={nav} />;
    return <ClientView nav={nav} />;
  };
      ...
      <div className="main">
        ...
        <div className="content">
          <div className="content-inner">
            ...
            {newLayout
              ? (role === "client" ? renderClient() : <TechView />)
