...
const I = {
  ...
  arrowLeft: (p) => <Ic {...p} d="M19 12H5M12 19l-7-7 7-7" />,
  lock: (p) => <Ic {...p} children={<><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></>} />,
  building: (p) => <Ic {...p} children={<><rect x="4" y="2" width="16" height="20" rx="2"/><path d="M9 22v-4h6v4M8 6h.01M16 6h.01M8 10h.01M16 10h.01M8 14h.01M16 14h.01"/></>} />,
  home: (p) => <Ic {...p} children={<><path d="M3 9.5 12 3l9 6.5V21a1 1 0 0 1-1 1h-5v-7H9v7H4a1 1 0 0 1-1-1V9.5z"/></>} />,
  refresh: (p) => <Ic {...p} children={<><path d="M3 12a9 9 0 0 1 15-6.7L21 8M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-15 6.7L3 16M3 21v-5h5"/></>} />,
};
