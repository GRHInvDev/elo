...
export default function NotificationsPage() {
  ...
  const notificationTypes = [
    ...
    { value: "SUGGESTION_CREATED", label: "Ideia criada" },
    { value: "SUGGESTION_UPDATED", label: "Ideia atualizada" },
    { value: "SUGGESTION_APPROVED", label: "Ideia aprovada" },
    { value: "SUGGESTION_REJECTED", label: "Ideia rejeitada" },
