...
import { SignInLoadGuard } from "@/components/auth/sign-in-load-guard"
        ...
        <SignInVerificationLoadingShell>
          ...
          >
            ...
            <CardContent className="flex min-w-0 flex-col items-stretch px-6 pb-6 pt-0 sm:px-7 sm:pb-7 sm:pt-1">
              <SignInLoadGuard>
                {/* Apenas `elements`, com classes do DS. As `variables` de cor do
                    Clerk exigem cor de verdade: ele nao resolve referencia a CSS
                    var como `hsl(var(--primary))`. As classes abaixo ja trazem os
                    tokens do tema, modo escuro incluido. */}
                <SignIn
                  appearance={{
                    elements: {
